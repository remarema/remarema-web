<%@include file='template/menu.jsp'%>								  
					...
					<section id="package_edit" class="two">
						...
						<form method="post" action="/remarema/package_edit?id=${id}">
							...
							<div class="row">
									<div class="12u">
										<input type="submit" value="Package updaten!" />
						...
						<br /> <br />
							...
							<form method="post" action="/remarema/distribute">
								<div class="row">
									<div class="10u"><input type="text" name="softwareID" value="${softwareNames}" /></div>
									<div class="2u"><input type="submit" value="Wählen" /></div>
								</div>
							</form>					
