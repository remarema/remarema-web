<%@include file='template/menu.jsp'%>						  
					...
					<section id="node_status" class="two">
						...
						<form method="post" action="/remarema/node_status?id=${id}">
							<div class="row">
							...
							<div class="row">
								...
								<div class="2u"><input type="text" name="networkID" value="${networkID}" /></div>
								<div class="6u"><input type="text" name="networkName" value="${networkName}" disabled /></div>
								<div class="2u"><a href="/remarema/network_status?id=${networkID}"><input id="inputbtn" type="text" value="View" disabled /></a></div>
							</div>
							<div class="row">
									<div class="12u">
						...
						<br /> <br />
							...
							<form method="post" action="/remarema/node_status?id=${id}&delete=true">
								<div class="row">
									<div class="12u">
